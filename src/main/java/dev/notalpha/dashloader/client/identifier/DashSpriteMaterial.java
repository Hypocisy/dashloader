...
public class DashSpriteMaterial implements DashObject<Material, Material> {
	public final int atlas;
	public final int texture;

	public DashSpriteMaterial(int atlas, int texture) {
		this.atlas = atlas;
		this.texture = texture;
	}

	public DashSpriteMaterial(Material identifier, RegistryWriter writer) {
